...
import { AuthenticatedUser, MaybeAuthenticatedUser, Movie, MovieListContext, NewMovie, UpdatedMovie, User } from "../../types";
...
async function updateMovie(id:number,updatedMovie : UpdatedMovie) {
  try {
    if (!authenticatedUser) {
